/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+css-extras+less */
...
Prism.languages.less['atrule'].pattern = /@[\w-]+?(?:\([^{}]+\)|[^(){};])*?(?=\s*\{)/i;
